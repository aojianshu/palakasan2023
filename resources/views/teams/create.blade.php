                    ...
                    <form action="{{ route('teams.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="md:flex justify-between items-center gap-4">
                            ...
                            <div class="w-full">
                                ...
                                <x-text-input id="strand" name="strand" type="text" class="block mt-1 w-full" :value="old('strand')" required autofocus autocomplete="strand"></x-text-input>
                                <x-input-error :messages="$errors->get('strand')" class="mt-2"></x-input-error>
                            </div>
                        </div>
                        <div class="mt-6 flex justify-end">
                            <x-primary-button class="w-2/12 justify-center">Add Team</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
